...
public class ClientData {
	...
	public void saveClientList(String key,List<UUID> list){
		...
		e.putStringSet(key, favset);
		e.commit();
		return;
	}
	

	public ArrayList<UUID> getClientList(String key) {
		...
		Set<String> favset = prefs.getStringSet(key, null);
